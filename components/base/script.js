...
components.rdMailform = {
	...
	init: function ( nodes ) {
		let i, j, k,
			...
			msg = {
				'MF000': 'Cadastrado com sucesso!',
				'MF001': 'Recipients are not set!',
				'MF002': 'Form will not work locally!',
				'MF003': 'Please, define email field in your form!',
				'MF004': 'Please, define type of your form!',
				'MF254': 'Something went wrong with PHPMailer!',
				'MF255': 'Opa! Alguma coisa deu errado, tente novamente.',
				'MF256': 'Você já está cadastrado!'
			};
				...
				beforeSubmit: function (arr, $form, options) {
					...
					if (isValidated(inputs, captcha)) {
						...
						if (output.hasClass("snackbar")) {
							...
							output.html('<div class="snackbar-inner"><div class="snackbar-title"><span class="icon snackbar-icon fa-circle-o-notch fa-spin"></span>Aguarde...</div></div>');
							output.addClass("active");
						}
					} else {
						return false;
